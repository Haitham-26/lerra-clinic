      ...
      <section>
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="overflow-hidden w-100 h-100 p-0 position-relative">
            ...
            <div class="p-0 position-absolute" style="margin-top: 25em">
              <div
            ...
            <div class="col-md-4 col-12 pw-blgs-crd text-ttl">
              ...
              <div class="d-flex flex-column gap-2 m-3">
                ...
                <p>
                  ...
                  it. They put a hard, safe-to-use item under the skin and soft
                  parts around your chin.Here is...
                </p>
              </div>
            ...
            <img class="w-100 h-100" src="./assets/img/search-page-recent-posts-1.jpg" />
              <div class="d-flex flex-column gap-2 m-3">
                ...
                <p>
                  ...
                  people. This makes it an ideal place for people who want this
                  kind of treatment due to its experienced...
                </p>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex gap-3 align-items-center">
            ...
            <img class="w-100 h-100" src="./assets/img/search-page-recent-posts-1.jpg" />
              <div class="d-flex flex-column gap-2 m-3">
                ...
                <p>
                  ...
                  However, all medical devices have their own limited life span.
                  With proper handling and care, chin implants can be there...
                </p>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex gap-3 align-items-center">
            ...
            <img class="w-100 h-100" src="./assets/img/search-page-recent-posts-1.jpg" />
              <div class="d-flex flex-column gap-2 m-3">
                ...
                <p>
                  ...
                  it too, to get a cut and shaped look. In men, the fat...
                </p>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex gap-3 align-items-center">
            ...
            <img class="w-100 h-100" src="./assets/img/search-page-recent-posts-1.jpg" />
              <div class="d-flex flex-column gap-2 m-3">
                ...
                <p>
                  ...
                  of the body. The first step involves giving anesthesia, which
                  could be either local or general depending on how much...
                </p>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex gap-3 align-items-center">
            ...
            <img class="w-100 h-100" src="./assets/img/search-page-recent-posts-1.jpg" />
              <div class="d-flex flex-column gap-2 m-3">
                ...
                <p>
                  ...
                  parts of the globe seeking beauty. Turkey has highly skilled
                  medical practitioners, modern medical facilities and
                  competitive prices. As a result it...
                </p>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex gap-3 align-items-center">
