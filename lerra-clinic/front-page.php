            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 gy-2">
                    <div class="pw-clss-trt-crd pw-crd-anm wow m-auto position-relative rounded-3 overflow-hidden" style="z-index: 1;">
                        ...
                        <div class="pw-clss-trt-crd-offr position-absolute">
                            <span class="pw-black-overlay p-2 rounded-pill fw-bold text-white text-center m-3">Exclusive Offer</span>
                        </div>
                        <div class="pw-clss-trt-crd-ttl position-absolute top-50">
                            <h2 class="text-white">Facial Plastic Surgery</h2>
                        </div>
                        <div class="pw-crd-vw opacity-50 position-absolute text-white d-flex justify-content-between align-items-center gap-2">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-3 gy-3">
                    <div class="d-flex flex-column justify-content-center align-items-center gap-2 pw-trns-3 pw-on-hvr-trns-top">
                        <div>
                            <img src="./assets/img/dur-treatment.jpg" alt="flight" class="w-100" />
                        </div>
                        <h3 class="text-sub fw-bold text-center">Duration of Treatment</h3>
                        <p class="text-ttl text-center">At the first appointment, a smile plan will be applied using images and x-rays. We organize all the details and start the treatment</p>
                    </div>
                </div>
                <div class="col-12 col-md-3 gy-3">
                    <div class="d-flex flex-column justify-content-center align-items-center gap-2 pw-trns-3 pw-on-hvr-trns-top">
                        <div>
                            <img src="./assets/img/happy-face.jpg" alt="flight" class="w-100" />
                        </div>
                        <h3 class="text-sub fw-bold text-center">Happy Return</h3>
                        <p class="text-ttl text-center">After your treatment and discovery of Istanbul, you will return home satisfied and happy.</p>
                    </div>
                </div>
                <div class="col-12 col-md-3 gy-3">
                    <div class="d-flex flex-column justify-content-center align-items-center gap-2 pw-trns-3 pw-on-hvr-trns-top">
