            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-md-5">
                    <div class="d-flex flex-column gap-1">
                        ...
                        <p class="fw-medium">We understand that every client has unique and special needs, so we strive to provide personalized services that exceed our clients' expectations. With "Complete Journey", you will get a comprehensive and comfortable experience.</p>
                    </div>
                </div>
                <div class="col-12 col-md-5">
                    <div class="w-100 pw-trns-3 pw-on-hvr-trns-top mb-4">
                        <img src="./assets/img/dummy_525x400_ffffff_cccccc.png" alt="lerra-clinic" class="w-100" data-aos="fade-up" />
                    </div>
                </div>
            </div>
        </div>
